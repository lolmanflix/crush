...
const KidsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-24 px-2 sm:px-6 lg:px-8">
      <h2 className="text-3xl font-bold mb-8 text-center text-black dark:text-white">Kids' Collection</h2>
      {kidsProducts.length === 0 ? (
        <div className="text-center text-gray-500">No kids' products found.</div>
      ) : (
